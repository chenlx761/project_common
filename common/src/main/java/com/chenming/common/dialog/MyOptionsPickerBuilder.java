...
public class MyOptionsPickerBuilder {
    ...
    public MyOptionsPickerBuilder addOnCancelClickListener(View.OnClickListener cancelListener) {
     ...
     */
    public MyOptionsPickerBuilder setItemVisibleCount(int count) {
     ...
     */
    public MyOptionsPickerBuilder isAlphaGradient(boolean isAlphaGradient) {
