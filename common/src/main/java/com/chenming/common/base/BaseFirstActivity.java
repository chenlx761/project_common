...
public abstract class BaseFirstActivity<VM extends BaseViewModel, VB extends ViewDataBinding>
    ...
    protected void showInfo(int resId) {
        ToastUtil.showShortToast(CommApplication.getInstance().getResources().getString(resId));
    }
